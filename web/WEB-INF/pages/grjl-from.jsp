...
<form>
    <table >
        ...
        专业：<textarea name="prof" id="prof" cols="130" rows="10"style="overflow-x:hidden" ></textarea>
        学历：<textarea name="education" id="education" cols="130" rows="10"></textarea><br>
        毕业学院：<textarea name="university" id="university" cols="130" rows="10"></textarea><br>
